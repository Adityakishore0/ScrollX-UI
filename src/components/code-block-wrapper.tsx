  ...
  return (
    <Collapsible open={isOpened} onOpenChange={setIsOpened}>
      <div className={cn('relative', className)} {...props}>
        <div className={cn('relative overflow-hidden bg-muted rounded-md')}>
          ...
          >
            <div
              className={cn(
                'relative w-full h-full max-h-162.5',
                isOpened
                  ? `
                  overflow-y-auto
                  overflow-x-hidden
                  ...
                  [scrollbar-color:rgb(161_161_170/0.5)_transparent]
                  dark:[scrollbar-color:rgb(63_63_70)_transparent]
                `
                  : 'overflow-hidden',
              )}
            >
              <div className='[&>div:first-child]:sticky [&>div:first-child]:top-0 [&>div:first-child]:z-10 [&_pre]:my-0 [&_pre]:h-full [&_pre]:w-full [&_pre]:overflow-x-auto [&_pre::-webkit-scrollbar]:hidden [&_pre]:[-ms-overflow-style:none] [&_pre]:[scrollbar-width:none]'>
                {children}
              </div>
            </div>
          </CollapsibleContent>
          ...
          <div
            className={cn(
              ...
              isOpened
                ? 'inset-x-0 bottom-0 h-12 bg-linear-to-t from-muted via-muted/80 to-transparent'
                : 'inset-0 bg-linear-to-t from-muted via-muted/50 to-transparent',
            )}
          >
