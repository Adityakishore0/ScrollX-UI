...
const ExploreCta = () => {
  return (
    <section className="relative z-[22] w-full py-20 bg-gradient-to-b from-white to-gray-50 dark:from-[#0b0b0b] dark:via-[#090909] dark:to-[#0b0b0b]">
      <div className="mx-auto max-w-[1200px] px-5 lg:px-8">
        ...
        >
          ...
          <span className="relative z-[2] block max-w-[600px] text-base sm:text-lg font-medium leading-tight dark:text-white/80 text-black/80">
