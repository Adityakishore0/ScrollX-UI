...
export function ComponentShowcase() {
  return (
    <section className='w-full py-12 bg-linear-to-t from-white to-gray-50 dark:bg-linear-to-b dark:from-[#0c0c0c] dark:via-black dark:to-[#0c0c0c] md:py-24 lg:py-32'>
...
function ShowcasePanel({ children }: { children: React.ReactNode }) {
  return (
    <div className='relative rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden h-95 flex items-center justify-center bg-muted/20'>
      {children}
    </div>
  );
}
