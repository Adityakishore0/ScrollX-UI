  ...
  return (
    <div className='h-160 w-full rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased'>
      <div className='max-w-2xl mx-auto p-4 relative z-10 text-center'>
        <h1 className='text-4xl md:text-7xl bg-clip-text text-transparent bg-linear-to-b from-white via-neutral-200 to-neutral-500 mb-4'>
          Dare to Dream Big
        </h1>
        <div className='h-px w-32 bg-linear-to-r from-transparent via-purple-500 to-transparent mx-auto mb-8' />
