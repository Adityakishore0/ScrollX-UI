...
export default function GlassHeroDemo() {
  return (
    <div className='relative select-none cursor-none w-full h-96 md:h-screen overflow-hidden'>
      <img
      ...
      <div className='absolute inset-0 flex flex-col items-center justify-center z-10 px-4 md:px-0'>
        ...
        <h1 className='bg-clip-text text-transparent text-center bg-linear-to-b  from-neutral-600 to-white text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight'>
          Summer is over
          <br />
          Winter has arrived
        </h1>
