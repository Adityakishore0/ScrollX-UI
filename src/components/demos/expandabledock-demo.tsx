  ...
  const groupedNavigation = [
    {
      ...
      children: navigation.filter((item) =>
        ['Getting Started', 'Introduction', 'Installation'].includes(
          item.title,
        ),
      ),
    },
        ...
        <div className='flex flex-col h-full'>
          <div className='mb-6 flex items-center gap-3 bg-gray-100 dark:bg-black rounded-xl px-4 py-3 border border-gray-200 dark:border-gray-600'>
            ...
            <input
              ...
              className='flex-1 bg-transparent outline-hidden text-sm text-gray-900 dark:text-white placeholder-gray-600 dark:placeholder-gray-400'
              value={query}
