...
export default function MeteorOrbitDemo() {
  return (
      ...
      <div className="relative z-10 flex flex-col h-full justify-between p-5">
        <div>
          ...
          <p className="mt-3 text-neutral-600 dark:text-neutral-400 text-sm max-w-xs">
            orbit system featuring rotating meteors and gracefully animated
            icons.
          </p>
        </div>
      </div>
      <div className="absolute bottom-0 right-0 w-[200px] h-[200px]">
        <div className="absolute bottom-0 right-0 translate-x-[20px] translate-y-[20px]">
