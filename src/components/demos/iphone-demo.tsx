    ...
    <div className='w-full max-w-sm mx-auto p-4'>
      <Iphone showHeader>
        <div className='absolute inset-0 bg-black z-10'>
          ...
          />
          <div className='absolute inset-0 bg-linear-to-b from-black/40 via-transparent to-black/80 z-20' />
          {showNotification && (
          ...
          <div className='absolute right-3 sm:right-5 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-2 sm:gap-3'>
            ...
            <Button
              size='icon'
              variant='ghost'
              className='rounded-full bg-white/10 hover:bg-white/20 h-10 w-10 sm:h-12 sm:w-12 backdrop-blur-xs transition-all hover:scale-110 hover:rotate-90'
