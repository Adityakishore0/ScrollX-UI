      ...
      >
        <span className="group inline-flex items-center cursor-pointer">
          <span className="relative inline-flex items-center transition-all duration-200 group-hover:translate-x-2 group-hover:pl-4">
            <span className="absolute left-0 opacity-0 rotate-[-45deg] transition-all duration-200 group-hover:opacity-100 group-hover:rotate-0">
              →
            </span>
            <span>Question? Give us feedback</span>
            <span className="ml-1 transition-all duration-200 rotate-[-45deg] group-hover:opacity-0 group-hover:translate-x-1">
              →
            </span>
          </span>
        </span>
