  ...
  return (
    <div ref={sectionRef}>
      <WaveBackground
        ...
        className="relative w-full py-8 md:py-12 overflow-hidden min-h-[90vh] flex flex-col items-center justify-center bg-gradient-to-b from-white to-gray-50 dark:from-[#0c0c0c] dark:via-[#000000] dark:to-[#0c0c0c] select-none"
      >
        <div className="w-full flex flex-col items-center px-4 sm:px-6 md:px-8">
          <Link href="/docs/changelog" className="relative z-10 mb-10">
            <Announcement className="group cursor-pointer border-transparent hover:border-border transition-colors">
              <AnnouncementTag movingBorder className="text-[8px] sm:text-xs">
