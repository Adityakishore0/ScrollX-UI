  ...
  rows={[
    {
      ...
      type: "SocialIcon[]",
      default: "[]",
      description: "Array of social icons with optional orbit index and position angle."
    },
    {
      prop: "children",
      type: "React.ReactNode",
      default: "undefined",
      description: "Content rendered at the center of the orbit animation."
    },
    {
      prop: "rippleCount",
      type: "number",
      default: "5",
      description: "Number of circular ripple orbits around the center."
    },
    {
      prop: "meteorSpeed",
      type: "number",
      default: "4",
      description: "Controls the rotation speed of meteor trails (lower = faster)."
    },
    {
      prop: "size",
      type: "number",
      default: "500",
      description: "Overall size (width and height) of the orbit container in pixels."
    },
    {
      prop: "className",
      type: "string",
      default: "undefined",
      description: "Custom class name for the main container."
    },
    {
      prop: "meteorClassName",
      type: "string | string[]",
      default: '""',
      description: "Additional Tailwind classes applied to meteor trails for styling."
    },
    {
      prop: "meteorGradients",
      type: "[string, string][]",
      default: "[]",
      description: "Array of gradient color pairs for each meteor trail."
    }
  ]}
/>
