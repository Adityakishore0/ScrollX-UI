...
```bash value="pkg"
npx shadcn@latest add @scrollxui/testimonials/testimonials-with-marquee
```
...
<Step>Install required UI components: [`Animated Testimonials`](/docs/components/animated-testimonials)</Step>
