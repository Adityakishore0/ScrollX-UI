    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-1">
        <div className="lg:grid lg:grid-cols-[minmax(16rem,16rem)_1fr] xl:grid-cols-[minmax(16rem,16rem)_1fr_minmax(16rem,16rem)]">
          <aside className="hidden lg:block w-full sticky z-[30] top-16 h-[calc(100vh-4rem)] overflow-y-auto">
            <Sidebar />
          </aside>
          ...
          <aside className="hidden xl:block w-full sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto">
